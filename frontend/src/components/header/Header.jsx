      ...
      <Container>
            <Wrapper>
                ...
                <Center>
                  ...
                  <Nav>
                    <NavLink to='/product' onClick={this} style={{ textDecoration: "none", color: "black"}}> Product </NavLink>
                  </Nav>
                  <Nav>
                  ...
                  <Nav>
                    <NavLink to='/manage' onclick={this} style={{ textDecoration: "none", color: "black"}}>Manage</NavLink>
                  </Nav>
                </Center>
                <Right>
                  <Person>
